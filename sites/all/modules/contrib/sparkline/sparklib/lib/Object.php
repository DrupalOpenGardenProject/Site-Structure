 ...
 * licenses.
 *
 * $Id: Object.php,v 1.2.2.2 2008/09/05 22:23:45 chris Exp $
 *
 */
...
function sparkline_error_handler($errno, $errstr, $errfile, $errline) {
  switch ($errno) {
  case E_ERROR:
    $message = "ERROR:    ";
    break;
...
} // function sparkline_error_handler
...
class Object {
  ...
  function Object($catch_errors = true) {
    ...
    //    if ($catch_errors) {
      set_error_handler('sparkline_error_handler');
      //}
  } // function Object
